...
public class InCallController extends CallsManagerListenerBase implements
    ...
    public void onCallStateChanged(Call call, int oldState, int newState) {
        ...
        maybeTrackMicrophoneUse(isMuted());
        boolean vibrateOnConnect = LineageSettings.System.getIntForUser(mContext.getContentResolver(),
            LineageSettings.System.VIBRATE_ON_CONNECT, 0, UserHandle.USER_CURRENT) == 1;
        boolean vibrateOnDisconnect = LineageSettings.System.getIntForUser(mContext.getContentResolver(),
            LineageSettings.System.VIBRATE_ON_DISCONNECT, 0, UserHandle.USER_CURRENT) == 1;
